...
class AIAgent:
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str) -> str:
        ...
        elif function_name == "restart_gateway":
            from tools.restart_gateway_tool import restart_gateway_tool as _restart_gateway_tool

            return _restart_gateway_tool(agent=self, args=function_args)
    ...
    def _execute_tool_calls_sequential(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        for i, tool_call in enumerate(assistant_message.tool_calls, 1):
            ...
            if function_name == "todo":
                ...
                function_result = _restart_gateway_tool(agent=self, args=function_args)
            elif function_name == "memory":
                target = function_args.get("target", "memory")
                from tools.memory_tool import memory_tool as _memory_tool
